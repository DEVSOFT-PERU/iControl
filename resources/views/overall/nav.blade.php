...
<div class="navbar navbar-default" id="navbar-second">
	...
	<div class="navbar-collapse collapse" id="navbar-second-toggle">
		<ul class="nav navbar-nav">
			...
			<!-- End Administracion y Control -->

			<!-- Gestion de Produccion -->
			<li class="dropdown mega-menu mega-menu-wide">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-stars position-left"></i> Gestión de Producción <span class="caret"></span></a>

				<div class="dropdown-menu dropdown-content">
					<div class="dropdown-content-body">
						<div class="row">
							<div class="col-md-3">
								<span class="menu-heading underlined">Registro</span>
								<ul class="menu-list">
									<li><a href="{{ route('produccion-create') }}"><i class="icon-spinner3 spinner position-left"></i> Producción</a></li>
									<li><a href=""><i class="icon-statistics"></i> Insumo</a></li>
									<li><a href=""><i class="icon-spinner3 spinner position-left"></i> Diseño</a></li>
									<li><a href=""><i class="icon-graph"></i> Corte</a></li>
									<li><a href=""><i class="icon-stats-dots"></i> Costura</a></li>
									<li><a href=""><i class="icon-graph"></i> Lavado</a></li>
									<li><a href=""><i class="icon-graph"></i> Acabado</a></li>
								</ul>
							</div>
							<div class="col-md-3">
